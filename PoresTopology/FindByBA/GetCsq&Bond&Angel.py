...
def CompareRange(list1, list2, threshold = 0.1):
    ...
    for value2 in list2:
        flag = False
        for value1 in list1:
            if abs(float(value1) - float(value2)) <= threshold:
...
def main():
    ...
    targetAdo = AdoFileDimension(r'P:\Project\PoreTopology\04_IndustryZEO\01_IZA-7\CHA\Ado_Manual\CHA-PPT 1_8.ado')
    ...
    target_atoms, target_bonds, target_angles = GetCsq_Bond_Angle(r'CHA-PPT 1_8.txt', target_atom_csq)
