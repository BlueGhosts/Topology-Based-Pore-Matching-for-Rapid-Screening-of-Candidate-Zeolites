...
class CifFile():
    ...
    def GetSymmetryEquivPosAsXyzs(self):
        ...
        if self.software == 'MaterialsStudio' or self.software == 'MS':
            information = self.content.split("_symmetry_equiv_pos_as_xyz")[-1].split('_cell_length_a')[0].split('loop_')[0]
    ...
    def GetAtoms(self):
        ...
        if self.software == 'MaterialsStudio' or self.software == 'MS':
            ...
            elif '_geom_bond_atom_site_label_1' in self.content:
                lines = self.content.split('_geom_bond_atom_site_label_1')[0].split('atom_site_label')[-1].split('\n')
            else:
