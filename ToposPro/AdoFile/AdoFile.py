# AdoFile V1.0
# V1.1 by wangjiaze on 2025-Feb-18 Add self.allCsqs  Modify self.TD10sByFramework to int type
...
class AdoFile():
    def __init__(self, filepath):
        ...
        TD10sByFramework = self.GetTD10ByFramework()
        self.TD10sByFramework = [ int(TD10) for TD10 in TD10sByFramework]
        self.atom_csqByFramework = self.GetAtom_CsqByFramework()
        self.csqs = list(self.atom_csq.values())
        self.allCsqs = [ list(atom_csqs.values()) for atom_csqs in self.atom_csqByFramework]
